...
(function() {
  ...
  FlowLine = (function() {
    ...
    FlowLine.prototype.draw = function(r) {
      ...
      this.left_label = r.text(this.ox + 1, this.oy - (this.size / 90) - 5, this.labelText()).attr({
        'text-anchor': 'start'
      });
      this.right_label = r.text(this.dx - 1, this.dy - (this.size / 90) - 5, this.labelText()).attr({
        'text-anchor': 'end'
      });
      this.left_label.show();
      return this.right_label.show();
    };
